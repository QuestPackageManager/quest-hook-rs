...
// `MyMethod`'s `this` is `&mut Il2CppObject`, not `&mut Il2CppString` - this
// hook declares the wrong type for it, so it should fail to compile.
#[hook(MyClass::MyMethod)]
fn my_hook(this: &mut Il2CppString, value: &mut Il2CppObject) -> bool {
